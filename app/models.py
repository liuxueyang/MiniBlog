...
class User(UserMixin, db.Model):
    ...
    # TODO: it should be a nick
    username = db.Column(db.String(64), unique=True, index=True)
    email = db.Column(db.String(64), unique=True, index=True)
    password_hash = db.Column(db.String(128))
    confirmed = db.Column(db.Boolean, default=False)
    # it should be user's real name
    ...
    def __init__(self, **kwargs):
        ...
        if not self.role:
            if self.email == current_app.config['MINIBLOG_ADMIN']:
                # this bug wastes me a lot of time!!!! should be 0xff
                # instead of Permission.ADMINISTER!!!!!!!!!!
    ...
    def gravatar(self, size=100, default='identicon', rating='g'):
        if request.is_secure:
            ...
            url = 'http://0.gravatar.com/avatar'
